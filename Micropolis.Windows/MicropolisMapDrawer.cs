...
using System.IO;
using Micropolis.Windows.MapLoader;
...
namespace Micropolis.Basic
{
    ...
    /// </summary>
    public class MicropolisMapDrawer : Game
    {
        ...
        public MicropolisMapDrawer() : base()
        {
        ...
        protected override void Initialize()
        {
            ...
            legacyMap = (new MapReader()).ReadFile(reader);
        ...
        protected override void Draw(GameTime gameTime)
        {
            ...
            //1. Draw Main Map
            for (int x = offsetPositionX; x < legacyMap.GetLength(0); x++)
            {
                for (int y = offsetPositionY; y < legacyMap.GetLength(1); y++)
                {
                    int tileId = legacyMap[x, y] & 1023;

                    if ((legacyMap[x, y] & 2048) == 2048 && animatedTiles.ContainsKey(tileId))
                    {
