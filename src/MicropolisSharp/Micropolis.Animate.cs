...
{
    /// <summary>
    /// Partial Class Containing the content of animate.cpp
    /// </summary>
    public partial class Micropolis
    {
        ...
        public void AnimateTiles()
        {
            ...
            for(int x = 0; x < Constants.WorldWidth; ++x)
            {
                ...
                {
                    tilevalue = Map[x, y];
                    if ((tilevalue & (ushort)MapTileBits.Animated).IsTrue())
                    {
        ...
        {
            if ((index < 0) || (index >= (int)MapTileCharacters.TILE_COUNT))
            {
                return -1;
            }
