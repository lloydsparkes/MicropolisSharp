...
public partial class Micropolis
{
    ...
    public void DoBudgetNow(bool fromMenu)
    {
        ...
        var total = fireInt + policeInt + roadInt;

        var yumDuckets = TaxFund + TotalFunds;
        ...
        else if (total > 0)
        {
                ...
                if (yumDuckets > fireInt)
                {
                    ...
                    else
                    {
                        ...
                        if (yumDuckets > 0)
                            ...
                            PolicePercentage = yumDuckets / (float)PoliceFund;
                        else
            ...
            else
            {
                ...
                if (yumDuckets > 0)
                    ...
                    RoadPercentage = yumDuckets / (float)RoadFund;
                else
