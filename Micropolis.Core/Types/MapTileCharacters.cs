...
public enum MapTileCharacters
{
    ...
    /// < Chimney animation at coal power plant
    /// (
    /// 2
    /// ,
    /// 0
    /// )
    /// .
    /// < 919 last animation tile for chimney at coal power plant
    /// (
    /// 2
    /// ,
    /// 0
    ...
    /// )
    /// .
    /// < 923 last animation tile for chimney at coal power plant
    /// (
    /// 3
    /// ,
    /// 0
    ...
    /// )
    /// .
    /// < 927 last animation tile for chimney at coal power plant
    /// (
    /// 2
    /// ,
    /// 1
    ...
    /// )
    /// .
    /// < 931 last animation tile for chimney at coal power plant
    /// (
    /// 3
    /// ,
    /// 1
