...
{
    private static readonly ushort[] RoadTable =
    {
        (ushort)MapTileCharacters.ROADS, (ushort)MapTileCharacters.ROADS2, (ushort)MapTileCharacters.ROADS,
        (ushort)MapTileCharacters.ROADS3,
        (ushort)MapTileCharacters.ROADS2, (ushort)MapTileCharacters.ROADS2, (ushort)MapTileCharacters.ROADS4,
        (ushort)MapTileCharacters.ROADS8,
        (ushort)MapTileCharacters.ROADS, (ushort)MapTileCharacters.ROADS6, (ushort)MapTileCharacters.ROADS,
        (ushort)MapTileCharacters.ROADS7,
        (ushort)MapTileCharacters.ROADS5, (ushort)MapTileCharacters.ROADS10, (ushort)MapTileCharacters.ROADS9,
        (ushort)MapTileCharacters.INTERSECTION
    };

    private static readonly ushort[] RailTable =
    {
        (ushort)MapTileCharacters.LHRAIL, (ushort)MapTileCharacters.LVRAIL, (ushort)MapTileCharacters.LHRAIL,
        (ushort)MapTileCharacters.LVRAIL2,
        (ushort)MapTileCharacters.LVRAIL, (ushort)MapTileCharacters.LVRAIL, (ushort)MapTileCharacters.LVRAIL3,
        (ushort)MapTileCharacters.LVRAIL7,
        (ushort)MapTileCharacters.LHRAIL, (ushort)MapTileCharacters.LVRAIL5, (ushort)MapTileCharacters.LHRAIL,
        (ushort)MapTileCharacters.LVRAIL6,
        (ushort)MapTileCharacters.LVRAIL4, (ushort)MapTileCharacters.LVRAIL9, (ushort)MapTileCharacters.LVRAIL8,
        (ushort)MapTileCharacters.LVRAIL10
    };

    private static readonly ushort[] WireTable =
    {
        (ushort)MapTileCharacters.LHPOWER, (ushort)MapTileCharacters.LVPOWER, (ushort)MapTileCharacters.LHPOWER,
        (ushort)MapTileCharacters.LVPOWER2,
        (ushort)MapTileCharacters.LVPOWER, (ushort)MapTileCharacters.LVPOWER, (ushort)MapTileCharacters.LVPOWER3,
        (ushort)MapTileCharacters.LVPOWER7,
        (ushort)MapTileCharacters.LHPOWER, (ushort)MapTileCharacters.LVPOWER5, (ushort)MapTileCharacters.LHPOWER,
        (ushort)MapTileCharacters.LVPOWER6,
        (ushort)MapTileCharacters.LVPOWER4, (ushort)MapTileCharacters.LVPOWER9, (ushort)MapTileCharacters.LVPOWER8,
        (ushort)MapTileCharacters.LVPOWER10
    };
    ...
    {
        if (tile >= 64 && tile <= 207) tile = (ushort)((tile & 0x000F) + 64);
        return tile;
    }
            ...
            case ConnectTileCommand.Wire:
                ...
                if (AutoBulldoze)
                {
                    ...
                    if ((mapVal & (ushort)MapTileBits.Bulldozable).IsTrue())
                    {
                        ...
                        if ((mapVal >= (ushort)MapTileCharacters.TINYEXP &&
                             mapVal <= (ushort)MapTileCharacters.LASTTINYEXP) ||
    ...
    public ToolResult LayDoze(int x, int y, ToolEffects effects)
    {
        ...
        if ((tile & (ushort)MapTileBits.Bulldozable).IsFalse()) return ToolResult.Failed; /* Check dozeable bit. */
        ...
        switch (tile)
        {
            case (ushort)MapTileCharacters.DIRT:
                effects.SetMapValue(x, y,
                    (ushort)MapTileCharacters.ROADS | (ushort)MapTileBits.Bulldozable | (ushort)MapTileBits.Burnable);
                break;
            ...
            case (ushort)MapTileCharacters.CHANNEL: /* Check how to build bridges, if possible. */
                ...
                if (x < Constants.WorldWidth - 1)
                {
                    ...
                    if (tile == (ushort)MapTileCharacters.VRAILROAD || tile == (ushort)MapTileCharacters.HBRIDGE
                                                                    || (tile >= (ushort)MapTileCharacters.ROADS &&
                                                                        tile <= (ushort)MapTileCharacters.HROADPOWER))
                    {
                ...
                if (x > 0)
                {
                    ...
                    if (tile == (ushort)MapTileCharacters.VRAILROAD || tile == (ushort)MapTileCharacters.HBRIDGE
                                                                    || (tile >= (ushort)MapTileCharacters.ROADS &&
                                                                        tile <= (ushort)MapTileCharacters.INTERSECTION))
                    {
                        effects.SetMapValue(x, y, (ushort)MapTileCharacters.HBRIDGE | (ushort)MapTileBits.Bulldozable);
                        break;
                    }
            ...
            case (ushort)MapTileCharacters.LHPOWER: /* Road on power */
                effects.SetMapValue(x, y,
                    (ushort)MapTileCharacters.VROADPOWER | (ushort)MapTileBits.Conductivity |
                    (ushort)MapTileBits.Burnable | (ushort)MapTileBits.Bulldozable);
                break;

            case (ushort)MapTileCharacters.LVPOWER: /* Road on power #2 */
                effects.SetMapValue(x, y,
                    (ushort)MapTileCharacters.HROADPOWER | (ushort)MapTileBits.Conductivity |
                    (ushort)MapTileBits.Burnable | (ushort)MapTileBits.Bulldozable);
                break;

            case (ushort)MapTileCharacters.LHRAIL: /* Road on rail */
                effects.SetMapValue(x, y,
                    (ushort)MapTileCharacters.HRAILROAD | (ushort)MapTileBits.Burnable |
                    (ushort)MapTileBits.Bulldozable);
                break;

            case (ushort)MapTileCharacters.LVRAIL: /* Road on rail #2 */
                effects.SetMapValue(x, y,
                    (ushort)MapTileCharacters.VRAILROAD | (ushort)MapTileBits.Burnable |
                    (ushort)MapTileBits.Bulldozable);
                break;
    ...
    public ToolResult LayRail(int x, int y, ToolEffects effects)
    {
        ...
        switch (tile)
        {
            case (ushort)MapTileCharacters.DIRT: /* Rail on Dirt */
                ...
                effects.SetMapValue(x, y,
                    (ushort)MapTileCharacters.LHRAIL | (ushort)MapTileBits.Bulldozable | (ushort)MapTileBits.Burnable);
            ...
            case (ushort)MapTileCharacters.CHANNEL: /* Check how to build underwater tunnel, if possible. */
                ...
                if (x < Constants.WorldWidth - 1)
                {
                    ...
                    if (tile == (ushort)MapTileCharacters.RAILHPOWERV || tile == (ushort)MapTileCharacters.HRAIL
                                                                      || (tile >= (ushort)MapTileCharacters.LHRAIL &&
                                                                          tile <= (ushort)MapTileCharacters.HRAILROAD))
                    {
                ...
                if (x > 0)
                {
                    ...
                    if (tile == (ushort)MapTileCharacters.RAILHPOWERV || tile == (ushort)MapTileCharacters.HRAIL
                                                                      || (tile > (ushort)MapTileCharacters.VRAIL &&
                                                                          tile < (ushort)MapTileCharacters.VRAILROAD))
                    {
                        effects.SetMapValue(x, y, (ushort)MapTileCharacters.HRAIL | (ushort)MapTileBits.Bulldozable);
                        break;
                    }
            ...
            case (ushort)MapTileCharacters.LHPOWER: /* Rail on power */
                effects.SetMapValue(x, y,
                    (ushort)MapTileCharacters.RAILVPOWERH | (ushort)MapTileBits.Conductivity |
                    (ushort)MapTileBits.Burnable | (ushort)MapTileBits.Bulldozable);
                break;

            case (ushort)MapTileCharacters.LVPOWER: /* Rail on power #2 */
                effects.SetMapValue(x, y,
                    (ushort)MapTileCharacters.RAILHPOWERV | (ushort)MapTileBits.Conductivity |
                    (ushort)MapTileBits.Burnable | (ushort)MapTileBits.Bulldozable);
                break;
    ...
    public ToolResult LayWire(int x, int y, ToolEffects effects)
    {
        ...
        switch (tile)
        {
            case (ushort)MapTileCharacters.DIRT: /* Wire on Dirt */
                ...
                effects.SetMapValue(x, y,
                    (ushort)MapTileCharacters.LHPOWER | (ushort)MapTileBits.Conductivity |
                    (ushort)MapTileBits.Burnable | (ushort)MapTileBits.Bulldozable);
            ...
            case (ushort)MapTileCharacters.CHANNEL: /* Check how to lay underwater wire, if possible. */
                ...
                if (x < Constants.WorldWidth - 1)
                {
                    ...
                    if ((tile & (ushort)MapTileBits.Conductivity).IsTrue())
                    {
                        tile &= (ushort)MapTileBits.LowMask;
                        tile = NeutralizeRoad(tile);
                        if (tile != (ushort)MapTileCharacters.HROADPOWER &&
                            tile != (ushort)MapTileCharacters.RAILHPOWERV && tile != (ushort)MapTileCharacters.HPOWER)
                        {
                            effects.SetMapValue(x, y,
                                (ushort)MapTileCharacters.VPOWER | (ushort)MapTileBits.Conductivity |
                                (ushort)MapTileBits.Bulldozable);
                            break;
                        }
                    }
                ...
                if (y < Constants.WorldHeight - 1)
                {
                    ...
                    if ((tile & (ushort)MapTileBits.Conductivity).IsTrue())
                    {
                        tile &= (ushort)MapTileBits.LowMask;
                        tile = NeutralizeRoad(tile);
                        if (tile != (ushort)MapTileCharacters.VROADPOWER &&
                            tile != (ushort)MapTileCharacters.RAILVPOWERH && tile != (ushort)MapTileCharacters.VPOWER)
                        {
                            effects.SetMapValue(x, y,
                                (ushort)MapTileCharacters.HPOWER | (ushort)MapTileBits.Conductivity |
                                (ushort)MapTileBits.Bulldozable);
                            break;
                        }
                    }
    ...
    public void FixZone(int x, int y, ToolEffects effects)
    {
        ...
        if (y > 0) FixSingle(x, y - 1, effects);

        if (x < Constants.WorldWidth - 1) FixSingle(x + 1, y, effects);

        if (y < Constants.WorldHeight - 1) FixSingle(x, y + 1, effects);

        if (x > 0) FixSingle(x - 1, y, effects);
    }
    ...
    public void FixSingle(int x, int y, ToolEffects effects)
    {
        ...
        if (tile >= (ushort)MapTileCharacters.ROADS && tile <= (ushort)MapTileCharacters.INTERSECTION)
        {
            ...
            if (y > 0)
            {
                tile = effects.GetMapTile(x, y - 1);
                tile = NeutralizeRoad(tile);
                if ((tile == (ushort)MapTileCharacters.HRAILROAD || (tile >= (ushort)MapTileCharacters.ROADBASE &&
                                                                     tile <= (ushort)MapTileCharacters.VROADPOWER))
            ...
            if (x < Constants.WorldWidth - 1)
            {
                tile = effects.GetMapTile(x + 1, y);
                tile = NeutralizeRoad(tile);
                if ((tile == (ushort)MapTileCharacters.VRAILROAD || (tile >= (ushort)MapTileCharacters.ROADBASE &&
                                                                     tile <= (ushort)MapTileCharacters.VROADPOWER))
            ...
            effects.SetMapValue(x, y,
                (ushort)(RoadTable[adjTile] | (ushort)MapTileBits.Bulldozable | (ushort)MapTileBits.Burnable));
            return;
        }
        ...
        if (tile >= (ushort)MapTileCharacters.LHRAIL && tile <= (ushort)MapTileCharacters.LVRAIL10)
        {
            ...
            if (y > 0)
            {
                ...
                if (tile >= (ushort)MapTileCharacters.RAILHPOWERV && tile <= (ushort)MapTileCharacters.VRAILROAD
                                                                  && tile != (ushort)MapTileCharacters.RAILHPOWERV &&
                                                                  tile != (ushort)MapTileCharacters.HRAILROAD
                                                                  && tile != (ushort)MapTileCharacters.HRAIL)
                    adjTile |= 0x0001;
            }
            ...
            if (x < Constants.WorldWidth - 1)
            {
                ...
                tile = NeutralizeRoad(tile);
                if (tile >= (ushort)MapTileCharacters.RAILHPOWERV && tile <= (ushort)MapTileCharacters.VRAILROAD
                                                                  && tile != (ushort)MapTileCharacters.RAILVPOWERH &&
                                                                  tile != (ushort)MapTileCharacters.VRAILROAD
                                                                  && tile != (ushort)MapTileCharacters.VRAIL)
                    adjTile |= 0x0002;
            }
            ...
            effects.SetMapValue(x, y,
                (ushort)(RailTable[adjTile] | (ushort)MapTileBits.Bulldozable | (ushort)MapTileBits.Burnable));
            return;
        }
        ...
        if (tile >= (ushort)MapTileCharacters.LHPOWER && tile <= (ushort)MapTileCharacters.LVPOWER10)
        {
            ...
            if (y > 0)
            {
                ...
                if ((tile & (ushort)MapTileBits.Conductivity).IsTrue())
                {
                    tile &= (ushort)MapTileBits.LowMask;
                    tile = NeutralizeRoad(tile);
                    if (tile != (ushort)MapTileCharacters.VPOWER && tile != (ushort)MapTileCharacters.VROADPOWER &&
                        tile != (ushort)MapTileCharacters.RAILVPOWERH) adjTile |= 0x0001;
                }
            }
            ...
            if (x < Constants.WorldWidth - 1)
            {
                ...
                if ((tile & (ushort)MapTileBits.Conductivity).IsTrue())
                {
                    tile &= (ushort)MapTileBits.LowMask;
                    tile = NeutralizeRoad(tile);
                    if (tile != (ushort)MapTileCharacters.HPOWER && tile != (ushort)MapTileCharacters.HROADPOWER &&
                        tile != (ushort)MapTileCharacters.RAILHPOWERV) adjTile |= 0x0002;
                }
            }
            ...
            if (y < Constants.WorldHeight - 1)
            {
                ...
                if ((tile & (ushort)MapTileBits.Conductivity).IsTrue())
                {
                    ...
                    tile = NeutralizeRoad(tile);
                    if (tile != (ushort)MapTileCharacters.VPOWER && tile != (ushort)MapTileCharacters.VROADPOWER &&
                        tile != (ushort)MapTileCharacters.RAILVPOWERH) adjTile |= 0x0004;
                }
            }
            ...
            if (x > 0)
            {
                ...
                if ((tile & (ushort)MapTileBits.Conductivity).IsTrue())
                {
                    ...
                    tile = NeutralizeRoad(tile);
                    if (tile != (ushort)MapTileCharacters.HPOWER && tile != (ushort)MapTileCharacters.HROADPOWER &&
                        tile != (ushort)MapTileCharacters.RAILHPOWERV) adjTile |= 0x0008;
                }
            }

            effects.SetMapValue(x, y,
                (ushort)(WireTable[adjTile] | (ushort)MapTileBits.BurnableOrBulldozableOrConductive));
        }
    }
}