...
public partial class Micropolis
{
    ...
    {
        if (!Position.TestBounds(x, y)) return (ushort)MapTileCharacters.DIRT;
    ...
    /// <param name="x"></param>
    /// <param name="y"></param>
    private int GetTrafficDensity(int x, int y)
    {
    ...
    /// <param name="x"></param>
    /// <param name="y"></param>
    private void SetTrafficDensity(int x, int y, int density)
    {
